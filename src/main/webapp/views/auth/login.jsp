...
<script>
    document.getElementById('loginForm').addEventListener('submit', function(e) {
        ...
        // Bu yerda haqiqiy kirish logikasi bo'ladi
        // Hozircha oddiy tekshiruv qilamiz
        if(email && password) {
            alert('Kirish muvaffaqiyatli! Yonalishlar sahifasiga o\'tilyapti...');
            // window.location.href = "dashboard.html"; // Keyin bosh sahifaga o'tkazish
        } else {
